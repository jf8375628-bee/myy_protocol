        ...
        <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery & Husi restoran timorense   </h1>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>hahan Favoritu iha fulan nee</h2>
                    <p class="lead">Dalan ne’ebé fasil liu atu halo pedidu hahan favoritu husi hahan top 6 sira nee </p>
                </div>
                <div class="row">
						<?php 					
